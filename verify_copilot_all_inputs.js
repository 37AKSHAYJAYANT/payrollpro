...
async function runTestSuite() {
  ...
  assert(
    Number(emp1.salaryStructure.basicSalary) === Number((emp1.salaryStructure.monthlyGross * 0.5).toFixed(2)),
    "Basic salary must be exactly 50% of Monthly Gross CTC per specs"
  );
  assert(
  ...
  const depts = ["Engineering", "Sales", "Finance", "Human Resources", "Operations"];
