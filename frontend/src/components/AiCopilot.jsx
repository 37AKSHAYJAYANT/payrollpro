    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          ...
          <span className="text-[10px] uppercase font-extrabold bg-white/25 px-1.5 py-0.5 rounded-full">MCP</span>
      ...
      {isOpen && (
        <div className="fixed bottom-20 right-6 w-96 sm:w-[440px] h-[600px] max-h-[85vh] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden transition-all duration-300 animate-in fade-in slide-in-from-bottom-5">
          {/* Header */}
          <div className="px-5 py-4 bg-gradient-to-r from-indigo-700 via-indigo-800 to-purple-800 text-white flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-extrabold text-sm tracking-wide">PayrollPro Copilot</h3>
                  <span className="text-[10px] bg-emerald-400 text-emerald-950 font-bold px-1.5 py-0.2 rounded-full">
                    LIVE
                  </span>
                </div>
                <p className="text-[11px] text-indigo-200">Model Context Protocol • 5 Tools Active</p>
              </div>
            </div>
          ...
          <div className="px-3 py-2 bg-white border-t border-gray-100 flex items-center gap-1.5 overflow-x-auto text-[11px]">
            <button
              ...
              className="whitespace-nowrap px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md font-medium transition"
            >
              🚨 Audit Anomalies
            </button>
            <button
          ...
          >
            <input
              ...
              placeholder="Ask anything about payroll, employees, or compliance..."
              className="flex-1 px-3.5 py-2.5 border border-gray-300 rounded-xl text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
            />
            <button
              type="submit"
              disabled={!input.trim() || isTyping}
              className="p-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition shadow-sm disabled:opacity-40 disabled:cursor-not-allowed"
              title="Send Prompt"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
